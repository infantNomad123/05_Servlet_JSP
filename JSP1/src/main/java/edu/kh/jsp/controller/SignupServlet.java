...
// 2) ("주소")와 Servlet을 캐핑해서 요청/응답 처리할 수 있게 함 
@WebServlet("/signup")
...
//		} else if(Integer.parseInt(inputAge) < 14) {// 나이가 14세 미만인지 확인
//			sb.append("<h3> 14세 이상만 가입가능합니다 </h3>");
//		} else {
//			sb.append("<h3> 가입 성공 </h3>");
//			
//			sb.append("<ul>");
//			sb.append(String.format("<li>  ID : %s </li>",  inputAge));
