...
public class ELServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// requestServletRequest 객체에 여러 속성을 추가!
		// - req.setAttribute("K", V);
		// - 추가된 속성 값은 위임 받은 JS에서 
		// ${K} 형테로 작성하면 출력 시 해당 위치에 V 가 출력됨
		...
		//DTO
		Book book1 = new Book("American Prometheus", "Martin J Sherwin", 18000);
		...
		// forward : 요청 위임 
		// - 원래 Servlet이 요청 받고 응답 
		//		결과 화면(HTML) 만들어 응답해야되는데
		// Java에서 HTML 콛, 쓰기 힘들어......
		...
		// 2) 요청 발송자(Request Dispatcher 생성) 
